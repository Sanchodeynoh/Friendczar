...
import { Settings, Plus, X, Play, Pencil, Flame, Heart, MessageCircle, Briefcase, GraduationCap, MapPin, Ruler, Sparkles, Languages as LanguagesIcon } from "lucide-react";
...
export default function Profile() {
  ...
  const addLanguage = () => {
    ...
    if (!l || languages.includes(l) || languages.length >= 5) return;
